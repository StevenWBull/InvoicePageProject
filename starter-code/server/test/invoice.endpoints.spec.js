...
describe("Invoice Endpoints", () => {
    ...
    describe("POST /api/invoice", () => {
        it("responds with 201 and inserts a new completed invoice", () => {
            ...
            return supertest(app)
                .post("/api/invoice")
                .send(completeInvoiceData)
                .expect(201);
        });

        it("responds with 201 and inserts a new NOT completed invoice", () => {
            ...
            return supertest(app)
                .post("/api/invoice")
                .send(incompleteInvoiceData)
                .expect(201);
        });
    });

    describe("PATCH /api/invoice", () => {
        it("responds with 201 and patches an existing invoice", () => {
    ...
    describe("DELETE /api/invoice", () => {
        it("responds with 201 and deactivated an invoice with items", () => {
            const deleteInvoiceIdentifier = {

            };

            return supertest(app)
                .post("/api/invoice")
                .send(deleteInvoiceIdentifier)
                .expect(201);
        });

        it("responds with 201 and deactivated an invoice WITHOUT items", () => {
            const deleteInvoiceIdentifier = {
